    ...
    return (
        <section id="products" className="py-20 bg-gradient-to-b from-white to-gray-50 flex items-center">
            <div className="container mx-auto px-4 md:px-8 w-full">
                ...
                >
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 items-stretch h-auto md:h-[450px]">
                        {/* Featured Product */}
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <CardContainer className="inter-var w-full h-full" containerClassName="py-0 h-full">
                                    <CardBody className="bg-white relative group/card border-black/[0.05] w-full h-full rounded-[2.5rem] p-8 border transition-all duration-300 hover:shadow-2xl hover:border-emerald-500/20 flex flex-col justify-between">
                        ...
                        {/* Grid Products */}
                        <div className="grid grid-cols-2 gap-4 h-[350px] md:h-full">
                            {gridProducts.map((product, idx) => (
                                <CardContainer key={product.name} className="inter-var w-full h-full" containerClassName="py-0">
                                    <CardBody className="bg-white relative group/card border-black/[0.05] w-full h-full rounded-[2rem] p-4 border hover:border-emerald-500/20 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col">
                                        <CardItem translateZ="30" className="w-full aspect-square mb-2 overflow-hidden rounded-2xl bg-gray-50">
                                            <img
                                                src={product.image}
